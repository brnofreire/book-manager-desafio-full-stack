...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-32 h-32 border-2 border-white rounded-full"></div>
          <div className="absolute top-20 right-20 w-2 h-2 bg-white rounded-full"></div>
          <div className="absolute bottom-32 left-32 w-3 h-16 bg-white/20"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-purple-100 text-lg leading-relaxed max-w-md">
            Você pode entrar para acessar sua coleção de livros favoritos.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                Novo aqui?{' '}
                <Link href="/register" className="font-semibold text-purple-600 hover:text-purple-500 transition">
                  Criar uma conta
                </Link>
              </p>
            </div>
